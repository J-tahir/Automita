...
const VerticalTabs = ({ parentName }) => {
  ...
  const urlTeacher = "https://automita-backend.vercel.app/api/timetables/teachers-get/201269@students.au.edu.pk";
  const urlClass = "https://automita-backend.vercel.app/api/timetables/classes-get/201269@students.au.edu.pk";
  const urlRoom = "https://automita-backend.vercel.app/api/timetables/rooms-get/201269@students.au.edu.pk";
  useEffect(() => {
    if (parentName == "class") {
      axios
        .get(urlClass)
